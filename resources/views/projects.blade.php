        ...
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              ...
              background-size:cover;
              width:500px;
              height:500px;" src="{{Storage::disk('public')->url('project/'.$project->image)}}" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  ...
                  <a href="{{route('project.details',$project->slug)}}" class="link-a">Click here to view
