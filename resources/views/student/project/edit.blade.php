...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
          <form action="{{route('student.project.update', $project->id)}}" method="POST">
              {{ csrf_field() }}
              @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input {{$project->status == 1 ? 'checked' : ''}} type="checkbox" class="form-control" id="publish" aria-describedby="statusHelp" placeholder="Status" name="status" value="1">
                      </div>
