          ...
          <div  class="container">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                        ...
                        transition: background 0.3s, opacity 0.3s;" class="form-horizontal" method="POST" action="{{ route('register') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input style="border: none; margin-top: 10px;" id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                                ...
                                <div style="margin-top: 10px;" class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input style="border: none; margin-top: 10px;" id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
                                ...
                                <div style="margin-top: 10px;" class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input style="border: none; margin-top: 10px;" id="username" type="text" class="form-control" name="username" value="{{ old('username') }}" required>
                                ...
                                <div style="margin-top: 10px;" class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input style="border: none; margin-top: 10px;" id="password-confirm" type="password" class="form-control" name="password_confirmation" required>
                                    </div>
                                </div>
