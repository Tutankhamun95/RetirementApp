            ...
            <div style="margin-bottom: 10px;" class="card shadow text-center card-outline-info h-100">
              <div  class="card-img-top">
                <h3>{{$project->title}}</h3>
                  ...
                  width:500px;
                  height:500px;"  src="{{Storage::disk('public')->url('project/'.$project->image)}}" class="grayscale img-fluid mx-auto d-block" alt="card image 3">
              </div>
              <div class="card-block d-flex flex-column">
                  ...
                  <div class="container ">
                    <div style="margin:5px;" class="row">
                    <div class="col-md-4">
                      <a style="margin-bottom:5px;" href="{{route('superadmin.project.show', $project->id)}}" class="btn btn-primary btn-icon-split">
                        <span class="icon text-white-50">
