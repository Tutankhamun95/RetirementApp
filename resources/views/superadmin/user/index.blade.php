    ...
    <div style="margin-bottom:15px;" class="card shadow text-center card-outline-info">
      <div class="container-fluid">
        <div style="margin:5px;" class="row">
          ...
          <div class="col-md-6">
            <p>Total Users:<span class="text-primary"> {{$users->count()}}</span></p>
          </div>
        </div>
        </div> 
    </div>
          ...
          <div class="col-md-6">
            <div style="margin-bottom: 10px;" class="card shadow text-center card-outline-info h-100">
              <div class="card-img-top">
                  <img src="{{Storage::disk('public')->url('user/'.$user->image)}}" class="grayscale img-fluid mx-auto d-block" alt="card image 3">
              </div>
              ...
              <p>{{$user->name}}</p>
                  <div class="container-fluid">
                    <div style="margin:5px;" class="row">
                    <div class="col-md-4">
                      <a style="margin-bottom:5px;" href="{{route('superadmin.user.show', $user->id)}}" class="btn btn-primary btn-icon-split">
                        <span class="icon text-white-50">
                    ...
                    <div class="col-md-4">
                      <a style="margin-bottom:5px;" href="{{route('superadmin.user.edit', $user->id)}}" class="btn btn-warning btn-icon-split">
                        <span class="icon text-white-50">
